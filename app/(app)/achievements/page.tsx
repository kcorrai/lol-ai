...
function AchievementCard({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center gap-3 rounded-xl border p-5 text-center transition-all",
        earned ? "bg-surface" : "bg-surface/50 opacity-50"
      )}
      style={earned ? { borderColor: `${tierColor}44` } : {}}
    >
      {/* Icon */}
      <div
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-text-muted">
            {data?.earnedCount ?? 0} / {data?.total ?? 0} rozet kazanıldı
          </p>
        </div>
      </div>
