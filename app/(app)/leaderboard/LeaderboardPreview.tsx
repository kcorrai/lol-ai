    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p
          className={cn(
            ...
            entry.isYou ? "text-accent" : "text-text"
          )}
        >
          {entry.name}
          {entry.isYou && (
            <span className="ml-1.5 text-[10px] font-medium text-accent/70">(that&apos;s you)</span>
          )}
        </p>
      ...
      <div className="hidden shrink-0 items-center gap-6 sm:flex">
        ...
        <div className="w-14 text-right">
          ...
          <p
            className={cn("text-sm font-bold", entry.winRate >= 55 ? "text-success" : "text-text")}
          >
            {entry.winRate}%
          </p>
        </div>
