      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="relative grid gap-6 md:grid-cols-3">
          ...
          <div className="absolute left-[calc(16.66%+32px)] right-[calc(16.66%+32px)] top-10 hidden h-px md:block"
            style={{ background: "linear-gradient(to right, transparent, rgba(200,155,60,0.25) 20%, rgba(200,155,60,0.25) 80%, transparent)" }} />
            ...
            <div key={number} className="gaming-card relative flex flex-col items-center rounded-2xl p-6 text-center">
              ...
              <div className="relative mb-5">
                <div
                  ...
                  style={{ boxShadow: "0 0 32px rgba(200,155,60,0.12), inset 0 1px 0 rgba(255,255,255,0.06)" }}
                >
                ...
                <span
                  ...
                  style={{ boxShadow: "0 0 12px rgba(200,155,60,0.5)" }}
                >
                  {number.slice(-1)}
                </span>
              </div>
