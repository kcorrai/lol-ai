...
import { championSplashUrl, DDRAGON_VERSION } from "@/lib/ddragon";
...
const TOOLS: readonly ToolTile[] = [
  { name: "Counter picker", href: "/tools/counter-picker", stat: "Every lane matchup", splash: "Malphite" },
  { name: "Tier list", href: "/tools/tier-list", stat: "All roles, all tiers", splash: "Jinx" },
  { name: "Draft analyzer", href: "/tools/draft-analyzer", stat: "Both sides graded", splash: "Orianna" },
  { name: "Champion builds", href: "/builds", stat: "Runes, items, skills", splash: "Ezreal" },
  { name: "ARAM tier list", href: "/aram/tier-list", stat: "Howling Abyss only", splash: "Lux" },
  { name: "Patch meta report", href: "/meta", stat: `Data Dragon ${DDRAGON_VERSION}`, splash: "Viktor" },
];
        ...
        <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2 lg:grid-cols-3">
          {TOOLS.map((t) => (
            ...
            >
              ...
              <Image
                src={championSplashUrl(t.splash)}
                alt=""
                aria-hidden
                fill
                sizes="(max-width: 1024px) 50vw, 400px"
                className="object-cover object-[50%_20%] opacity-[0.55] brightness-[0.85] saturate-[0.9] transition-[opacity,filter] duration-[260ms] ease-out group-hover:opacity-95 group-hover:brightness-110 group-hover:saturate-100 motion-reduce:transition-none"
              />
