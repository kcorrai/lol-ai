...
const STEPS: readonly Step[] = [
  ...
  { n: "02", title: "20 games parsed", detail: "Full timelines. ~90 seconds." },
...
export function HowItWorksStrip(): React.ReactElement {
  return (
    <section className="px-5 pt-16 md:px-8 md:pt-[72px]">
      <div className="mx-auto grid max-w-[1240px] grid-cols-1 gap-px border border-border bg-line-1 md:grid-cols-3">
        {STEPS.map((s) => (
          <div key={s.n} className="flex items-baseline gap-3 bg-background px-5 py-5">
