 ...
 *
 * The reading itself is `BuildReading`, shared with the champion browser — this panel is
 * the half that knows about the live game and its four ways of having nothing to show.
 */
