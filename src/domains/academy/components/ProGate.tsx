  ...
  return (
    <section className="notch relative mt-8 border border-line-2 bg-surface p-6">
      ...
      <p className="mt-2 max-w-xl text-[14px] leading-relaxed text-text-body">
        Everything above is the concept. Behind the gate: the situations where it applies, the
        mistake that costs the most, the interactive drills, and a field assignment measured against
        your own ranked games.
      </p>
