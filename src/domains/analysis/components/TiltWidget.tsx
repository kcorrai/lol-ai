    ...
    <div className="rounded-xl border border-border bg-surface p-4">
      ...
      <div className="mb-3 flex gap-4 text-xs text-text-muted">
        <span>
          ...
          <span
            className={
              tilt.lossStreak >= 3 ? "font-semibold text-danger" : "font-semibold text-text"
            }
          >
            {tilt.lossStreak}
          </span>
        ...
        <span>
          Win rate:{" "}
          <span className="font-semibold text-text">{Math.round(tilt.recentWinRate * 100)}%</span>
        </span>
        <span>
          KDA trend:{" "}
          <span
            className={
              tilt.kdaTrend === "improving"
                ? "font-semibold text-success"
                : tilt.kdaTrend === "declining"
