...
export function buildCandidates(profile: PlayerPerformanceProfile): ImprovementTarget[] {
...
export function getCurrentValue(metric: PlanMetric, profile: PlayerPerformanceProfile): number {
...
export function buildPlanWithProgress(
