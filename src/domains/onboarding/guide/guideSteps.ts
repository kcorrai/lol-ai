...
export const GUIDE_STEPS: GuideStep[] = [
  ...
  {
    id: "click-my-name",
    target: "my-profile-link",
    placement: "bottom",
    padding: 6,
    title: "Open your profile",
    body: "Every name here opens that player's page. Click your own — the highlighted one — to see yours.",
  ...
  {
    id: "go-champions",
    target: "nav-champions",
    placement: "right",
    padding: 6,
    title: "Your champion pool",
    body: "Every champion you play, ranked by performance. Click the glowing “Champions”.",
    advance: { type: "route", route: "/champion-pool" },
    goTo: "/champion-pool",
  },
  {
    id: "champions-inside",
    target: "champion-pool-grid",
    placement: "top",
    padding: 10,
    title: "Deep-dive any champion",
    body: "Win rate, KDA, CS and a full breakdown per champion — click any card to dig in.",
    advance: { type: "manual" },
    skipIfMissing: true,
  },
  {
    id: "go-coach-chat",
    target: "nav-coach-chat",
    placement: "right",
    padding: 6,
    title: "Chat with your coach",
    body: "Ask me anything, any time. Click the glowing “Coach Chat”.",
    advance: { type: "route", route: "/coaching/chat" },
    goTo: "/coaching/chat",
  },
  {
    id: "coach-chat-try",
    ...
    placement: "top",
    padding: 8,
    title: "Ask me a real question",
    body: "Type something like “what should I focus on?” — I answer from your own games.",
    advance: { type: "manual" },
    skipIfMissing: true,
  },
  {
    ...
    placement: "right",
    padding: 6,
    title: "One-trick smarter",
    body: "Master a single champion — matchups, bans and tips. Click the glowing “OTP Assistant”.",
    advance: { type: "route", route: "/otp" },
    goTo: "/otp",
  },
  {
    id: "otp-inside",
    target: "otp-recommendations",
    placement: "bottom",
    padding: 10,
    title: "Your best one-tricks",
    body: "Picked from your own stats — tap one for a full champion guide.",
    advance: { type: "manual" },
    skipIfMissing: true,
  },
  {
    ...
    body: "Share the app and you both get perks. Click the glowing “Profile”.",
    advance: { type: "route", route: "/settings/profile" },
  ...
  },
  {
    ...
    body: "Copy your invite link and send it over — rewards land when they join.",
    advance: { type: "manual" },
    skipIfMissing: true,
  },
  {
    ...
    placement: "right",
    padding: 6,
    title: "Reports in Discord",
    body: "Pipe your coaching straight to a Discord channel. Click the glowing “Discord”.",
    advance: { type: "route", route: "/settings/discord" },
    goTo: "/settings/discord",
  },
  {
    id: "discord-webhook",
    ...
    body: "Create a webhook in your Discord channel and paste the URL here to get reports delivered.",
    advance: { type: "manual" },
    skipIfMissing: true,
  },
  {
