...
export function DangerZone({ teamId, teamName }: DangerZoneProps) {
  ...
  return (
    <div className="space-y-4 rounded-xl border border-danger/30 bg-danger/5 p-5">
      ...
      <p className="text-xs leading-relaxed text-text-muted">
        Deleting the team is irreversible. All membership data, invites, and team history will be
        deleted.
      </p>
      ...
      {!confirm ? (
        ...
        <div className="space-y-3">
          <p className="text-xs font-medium text-text">
            Type the team name to confirm: <span className="font-bold text-danger">{teamName}</span>
          </p>
          <input
            type="text"
            value={input}
