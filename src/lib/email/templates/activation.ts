          ...
          <tr>
            <td style="background:#0C1110;padding:32px;">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:28px;">
                <tr>
                  <td style="background:#17201F;border-radius:10px;padding:20px 24px;">
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="padding:6px 0;">
                          <span style="color:#C6FF3D;font-weight:700;margin-right:10px;">✓</span>
                          <span style="font-size:14px;color:#A7BCB5;">Riot account connected</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;">
                          <span style="color:#C6FF3D;font-weight:700;margin-right:10px;">→</span>
                          <span style="font-size:14px;color:#E9F5EE;font-weight:600;">Get your first AI report</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;">
                          <span style="color:#485954;font-weight:700;margin-right:10px;">○</span>
                          <span style="font-size:14px;color:#6C817B;">Create a personal improvement plan</span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <p style="margin:24px 0 0;font-size:13px;color:#6C817B;">
