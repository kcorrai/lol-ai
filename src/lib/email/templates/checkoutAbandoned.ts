...
export function buildCheckoutAbandonedEmail(
  ...
  const contentHtml = `<h1 style="margin:0 0 12px;font-size:22px;font-weight:700;color:#E8E6F0;">
                Finish upgrading to Pro
              </h1>
              <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#A0AEC0;">
                Hi <strong style="color:#E8E6F0;">${safeName}</strong>, you started upgrading to LoL AI Coach Pro but didn't finish.
              </p>
              <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#A0AEC0;">
